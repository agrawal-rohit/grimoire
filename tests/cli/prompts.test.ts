...
import { textInput, selectInput, multiselectInput, confirmInput } from '../../src/cli/prompts'
...
describe('prompts', () => {
  ...
  describe('textInput', () => {
    test('should call consola.prompt with correct parameters', async () => {
      ...
      expect(mockPrompt).toHaveBeenCalledWith(message, expect.objectContaining({
        type: 'text',
        cancel: 'symbol'
      }))
    })
    ...
    test('should handle default value', async () => {
      ...
      expect(mockPrompt).toHaveBeenCalledWith(expect.any(String), expect.objectContaining({
    ...
    test('should error when required is true and input is empty', async () => {
      ...
      await expect(() => textInput('Enter name', { required: true })).rejects.toThrow('process.exit called with code 1')
    ...
    test('should call logger.end when operation is canceled', async () => {
      ...
      await expect(() => textInput('Enter text')).rejects.toThrow('process.exit called with code 0')
  ...
  describe('selectInput', () => {
    ...
    test('should call logger.end when operation is canceled', async () => {
      ...
      await expect(() => selectInput('Select', { options: [] })).rejects.toThrow('process.exit called with code 0')
  ...
  describe('multiselectInput', () => {
    ...
    test('should return array of selected values', async () => {
      ...
      const result = await multiselectInput('Select multiple', { options: ['option1', 'option2', 'option3'] })
  ...
  describe('confirmInput', () => {
    ...
    test('should call logger.end when operation is canceled', async () => {
      ...
      await expect(() => confirmInput('Confirm?')).rejects.toThrow('process.exit called with code 0')
